...
class Place(BaseModel, Base):
     """
    Defines the blueprint of a place
    ...
    def __init__(self, *args, **kwargs):
        """This function initializes Place"""
        super().__init__(*args, **kwargs)

    if environ.get('HBNB_TYPE_STORAGE') != 'db':
        @property
        def reviews(self):
            """This function returns the list of Review instances with place_id equals to
        ...
        @property
        def amenities(self):
            """This function returns the list of Amenity instances based on the attribute
        ...
        def amenities(self, obj):
            """This function Handles the append method for adding an Amenity.id to the attribute
